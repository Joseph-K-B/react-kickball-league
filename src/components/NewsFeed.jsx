    ...
    return(
        <>            
            ...
            <article>
                <h3>Fake News</h3>
                <p>
                    The winter league will be starting soon. Our field for the season is located just short of the peak of Mt. Hood.
                    To comply with PDX kickball league's ADA standards we've installed an elevator through the vent of the volcano.
                    In order to access the elevator go to the gates of Moria and speak the elvish word for friend.
                </p>
            </article>
            <article>
                <h3>Real Fake News</h3>
                <p>
                    ...
                    hold your breath for a minimum of 15 minutes, and applicant must be able to do a backflip. Pay starts at 7.25 a week. Benefits include pizza parties.
                </p>
            </article>
            <article>
